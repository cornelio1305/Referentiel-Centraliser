        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Modifier le script : {{ $script->name }}</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           id="name" name="name" value="{{ old('name', $script->name) }}" required>
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              id="description" name="description" rows="3">{{ old('description', $script->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror"
                                              ...
                                              placeholder="Entrez votre code SQL ici...">{{ old('content', $script->content) }}</textarea>
                                    @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('version') is-invalid @enderror"
                                                   id="version" name="version" value="{{ old('version', $script->version) }}" required>
                                            @error('version')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror"
                                                ...
                                                @foreach($statuses as $value => $label)
                                                    <option value="{{ $value }}" {{ old('status', $script->status) == $value ? 'selected' : '' }}>
                                                        {{ $label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('db_target') is-invalid @enderror"
                                                ...
                                                @foreach($dbTargets as $value => $label)
                                                    <option value="{{ $value }}" {{ old('db_target', $script->db_target) == $value ? 'selected' : '' }}>
                                                        {{ $label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('author') is-invalid @enderror"
                                                   id="author" name="author" value="{{ old('author', $script->author) }}">
                                            @error('author')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('server_name') is-invalid @enderror"
                                                   id="server_name" name="server_name" value="{{ old('server_name', $script->server_name) }}">
                                            @error('server_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('database_name') is-invalid @enderror"
                                                   id="database_name" name="database_name" value="{{ old('database_name', $script->database_name) }}">
                                            @error('database_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('related_application') is-invalid @enderror"
                                                   id="related_application" name="related_application" value="{{ old('related_application', $script->related_application) }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('related_job') is-invalid @enderror"
                                                   id="related_job" name="related_job" value="{{ old('related_job', $script->related_job) }}">
                                            @error('related_job')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('documentation') is-invalid @enderror"
                                                      id="documentation" name="documentation" rows="3">{{ old('documentation', $script->documentation) }}</textarea>
                                            @error('documentation')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('change_reason') is-invalid @enderror"
                                                   id="change_reason" name="change_reason" value="{{ old('change_reason') }}"
                                                   placeholder="Ex: Correction de bug, amélioration...">
                                            @error('change_reason')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="form-text">Cette raison sera enregistrée dans l'historique des versions</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
